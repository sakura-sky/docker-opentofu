...
docker buildx build --push --platform linux/amd64,linux/arm64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-alpine-3.19" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/alpine319 -q  
docker buildx build --push --platform linux/amd64,linux/arm64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-alpine" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/alpine319 -q  
...
docker buildx build --push --platform linux/amd64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-debian-bullseye" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/debian-bullseye -q  
docker buildx build --push --platform linux/amd64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-debian-bullseye-slim" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/debian-bullseye-slim -q
...
docker buildx build --push --platform linux/amd64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-ubuntu-2204" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/ubuntu2204 -q  
docker buildx build --push --platform linux/amd64 -t "sakurasky/opentofu:$OPENTOFU_VERSION-ubuntu" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/ubuntu2204 -q  
docker buildx build --push --platform linux/amd64,linux/arm64 -t "sakurasky/opentofu:latest" --build-arg OPENTOFU_VERSION=$OPENTOFU_VERSION opentofu/alpine319 -q  
